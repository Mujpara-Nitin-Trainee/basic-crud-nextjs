  ...
  return (
    <>
      ...
      <div className="flex justify-center my-3 w-3/7">
        <button type="button" className="border-2 border-black px-2 mx-1" onClick={handleIncrement}>+</button>
        <button type="button" className="border-2 border-black px-2 mx-1">clone</button>
      </div>

      {fields.map((ele, index) => {
        return <div key={index}>
          <div className="flex justify-center ml-[1000px]">
