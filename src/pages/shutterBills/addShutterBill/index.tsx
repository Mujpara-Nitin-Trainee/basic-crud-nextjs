...
export default function Employee() {
  ...
  return <>
    ...
    <div className="flex justify-center w-3/4 my-10">
      <button type="button" className="border-2 border-black px-1.5 py-0.5" onClick={() => router.push('/shutterBills')}>Listing Page</button>
    </div>
  </>
}
